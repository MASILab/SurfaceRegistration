...
#turn the ply into a VTK
# vtk_out = out_dir/("{}.vtk".format(pref))
# utils.convert_ply_to_vtk(vtk_in, vtk_out)


#do a color segmentation
vtk_color = out_dir/("{}_color.vtk".format(pref))
####utils.color_threshold_mesh(vtk_in, vtk_color, abs_threshold=[150,200,150], g_abs_thresh=90)
#utils.color_threshold_mesh(vtk_in, vtk_color, abs_threshold=[150,200,150], g_abs_thresh=50)

#do a connected component segmentation (by point)
pid = int(args.pid)
